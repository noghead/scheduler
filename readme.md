**NOTE** If you are coming across this project looking for a scheduler, it is still under construction but feel free to use it as inspiration or example for using Quartz.
